...
if __name__ == '__main__':
    ...
    classify(classify("test/snapshot_iter_21120.caffemodel", "test/deploy.prototxt", args['image_file'], 
            "test/mean.binaryproto", "test/labels.txt",args['batch_size'], not args['nogpu'])
